...
const NGOMAProductsPage = () => {
  ...
  const fetchNGOMAProducts = async (pageNum = 1, sortBy = 'name', order = 'asc') => {
    setIsLoading(true);
    try {
  ...
  const handleSortBy = (name, order, value) => {
    ...
    fetchNGOMAProducts(page, name, order);
    setAnchorEl(null);
  };

  const handlePageChange = (event, value) => {
    fetchNGOMAProducts(value, selectedSortVal.includes('Price') ? 'price' : 'name', 
      ...
      <div className="bg-white p-2">
        <div className="container">
          ...
          <Breadcrumbs aria-label="breadcrumb" className="mb-4 pt-4">
            ...
            <span className="text-gray-600">NGOMA Products</span>
          </Breadcrumbs>

          {/* Header Section */}
          <div className="mb-6">
            <h1 className="text-[28px] sm:text-[32px] md:text-[36px] lg:text-[40px] font-[700] text-[#0b2735] mb-2">
              NGOMA Products
            </h1>
            <p className="text-[14px] sm:text-[16px] text-gray-600">
              Discover our exclusive collection of NGOMA products. Premium quality, authentic designs.
            </p>
          </div>
          ...
          {!isLoading && productsData?.products?.length === 0 && (
            <div className="text-center py-12">
              <p className="text-[18px] text-gray-600 mb-4">No NGOMA products found at the moment.</p>
              <Link to="/products">
...
export default NGOMAProductsPage;
